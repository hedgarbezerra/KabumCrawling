...
namespace KabumCrawling.Repository.Context.Configuration
{
    public class NotificacaoConfiguration : EntityConfiguration<NotificacaoProduto>
    {
        protected override void ConfigurateFields()
        {
            ...
            Property(p => p.NomeDestinario)
                .HasColumnName("NOME_DESTINARIO")
                .HasColumnType("VARCHAR")
                .IsRequired();

            Property(p => p.ContatoDestinario)
                .HasColumnName("CONTATO_DESTINARIO")
                .HasColumnType("VARCHAR")
                .IsRequired();

            Property(p => p.EmailDestinario)
                .HasColumnName("EMAIL_DESTINARIO")
                .HasColumnType("VARCHAR")
                .IsRequired();
